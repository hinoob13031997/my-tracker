/* STACK v27.5.5 — unified runtime bootstrap for shell identity and optional modules. */
(()=>{'use strict';
const BUILD='27.5.5';
function shell(){
  document.title='STACK — Персональная система управления';
  document.querySelector('meta[name="stack-build"]')?.setAttribute('content','v27.5.5');

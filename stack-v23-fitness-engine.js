...
.fx-workout-ready{margin-top:11px;padding:10px;border:1px solid #287550;border-radius:12px;background:#071d18;color:#a7e9bd;font-size:9px;line-height:1.4}.fx-workout-ready button{width:100%;min-height:44px;margin-top:8px;border:1px solid #68d43f;border-radius:10px;background:#11331d;color:#9af27f;font-size:9px;font-weight:900;box-shadow:0 0 10px #68d43f2b}.fx-save-actions{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:10px}.fx-save-actions .fx-save{margin-top:0}.fx-save-secondary{min-height:47px;border:1px solid #31516b;border-radius:10px;background:#07131f;color:#c4d3e5;font-size:9px;font-weight:900}

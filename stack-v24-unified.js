...
function installStyle(){
  ...
  style.textContent+=`@media(max-width:720px){.v24-card-head{display:grid;grid-template-columns:36px minmax(0,1fr);gap:9px;align-items:center}.v24-card-icon{width:34px;height:34px;display:grid;place-items:center;border:1px solid currentColor;border-radius:11px;color:var(--icon,#0eb1db);background:#06111e;font-size:16px;font-weight:950;box-shadow:0 0 11px currentColor}.v24-card-head h3{margin:3px 0 0}.v24-card.cyan{--icon:#0eb1db}.v24-card.pink{--icon:#f12bb8}.v24-card.purple{--icon:#9133e4}#screenSavings.v24-finance-ready #v2220Finance>.v2220-tabs{display:none!important}.v24-finance-tabs button.on{border-color:#9133e4;background:#21103b;color:#fff;box-shadow:0 0 11px #9133e444}}`;
